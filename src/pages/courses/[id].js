                            ...
                            <div className="mx-auto w-3/4">
                                <div className="flex items-center">
                                    ...
                                    <a href={`${process.env.NEXT_PUBLIC_MEMBERPAGE_URL}/joined/${data.id}`} target="_blank" 
                                     rel="noopener noreferrer" className="bg-orange-500 hover:bg-orange-400 transition-all duration-200
                                     focus:outline-none shadow-inner text-white px-6 py-3 whitespace-no-wrap">
                ...
                <div className="w-3/4 mx-auto mt-8">
                    <div className="w-3/1">
                        ...
                        <section className="mt-10">
                            ...
                            {
                                data?.chapters?.length > 0 ? ( <RenderPreview previews={data.chapters}> </RenderPreview> ) :
...
DetailslCourses.getInitialProps = async (props) => {
...
export default DetailslCourses;
